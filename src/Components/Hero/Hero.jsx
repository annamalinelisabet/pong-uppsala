      ...
      <div className='black'>
          ...
          <div className='bg-img'>
            <div className='info-wrapper container'>
                  <div className='text-wrapper' data-aos="fade-down" data-aos-duration="600" data-aos-easing="ease-in-sine">
                ...
                <div className='line' data-aos="fade-down" data-aos-duration="1000" data-aos-easing="ease-in-sine"></div>
                <div className='lg-text-wrapper' data-aos="fade-left" data-aos-duration="700" data-aos-easing="ease-in-sine">
                ...
                <div className='btn-wrapper' data-aos="fade-up" data-aos-duration="600" data-aos-easing="ease-in-sine" >
